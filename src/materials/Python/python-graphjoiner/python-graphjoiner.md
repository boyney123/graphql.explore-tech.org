---
path: '/materials/python-graphjoiner'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'python-graphjoiner'
  url: 'https://github.com/healx/python-graphjoiner'
  github_url: 'https://github.com/healx/python-graphjoiner'
  subscribers_count: '7'
  stargazers_count: '44'
  tags: ['']
  subtitle: 'Implementing GraphQL with joins to avoid the N+1 problem'
  clone_url: 'https://github.com/healx/python-graphjoiner.git'
  ssh_url: 'git@github.com:healx/python-graphjoiner.git'
  pushed_at: '2019-01-24T23:05:08Z'
  updated_at: '2019-01-24T23:05:09Z'
  author:
    name: 'healx'
    avatar: 'https://avatars2.githubusercontent.com/u/13640055?v=4'
    github_url: 'https://github.com/healx'
  latestRelease:
    tag_name: null
    name: null
    url: null
