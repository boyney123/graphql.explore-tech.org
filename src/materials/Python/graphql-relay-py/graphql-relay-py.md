---
path: '/materials/graphql-relay-py'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-relay-py'
  url: 'https://github.com/graphql-python/graphql-relay-py'
  github_url: 'https://github.com/graphql-python/graphql-relay-py'
  subscribers_count: '9'
  stargazers_count: '105'
  tags: ['']
  subtitle: 'A library to help construct a graphql-py server supporting react-relay'
  clone_url: 'https://github.com/graphql-python/graphql-relay-py.git'
  ssh_url: 'git@github.com:graphql-python/graphql-relay-py.git'
  pushed_at: '2017-11-22T20:40:04Z'
  updated_at: '2019-01-16T07:52:34Z'
  author:
    name: 'graphql-python'
