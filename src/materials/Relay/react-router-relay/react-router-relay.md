---
path: '/materials/react-router-relay'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'react-router-relay'
  url: 'https://github.com/relay-tools/react-router-relay'
  github_url: 'https://github.com/relay-tools/react-router-relay'
  subscribers_count: '28'
  stargazers_count: '569'
  tags: ['react','relay','router']
  subtitle: 'Relay integration for React Router'
  clone_url: 'https://github.com/relay-tools/react-router-relay.git'
  ssh_url: 'git@github.com:relay-tools/react-router-relay.git'
  pushed_at: '2017-08-14T21:03:36Z'
  updated_at: '2019-02-09T20:03:23Z'
  author:
    name: 'relay-tools'
  ...
  latestRelease:
    tag_name: 'v0.14.0'
    name: 'v0.14.0'
    url: 'https://github.com/relay-tools/react-router-relay/releases/tag/v0.14.0'
    created_at: '2017-05-30T19:47:05Z'
---
