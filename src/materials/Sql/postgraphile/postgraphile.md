---
path: '/materials/postgraphile'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'postgraphile'
  url: 'https://graphile.org/postgraphile'
  github_url: 'https://github.com/graphile/postgraphile'
  subscribers_count: '127'
  stargazers_count: '6726'
  tags: ['api','automatic-api','express','graphile','graphql','graphql-api','graphql-js','http','instant','koa','koa2','node','nodejs','pg','pgsql','postgraphql','postgres','postgresql','schema','typescript']
  subtitle: 'Execute one command (or mount one Node.js middleware) and get an instant high-performance GraphQL API for your PostgreSQL database!'
  clone_url: 'https://github.com/graphile/postgraphile.git'
  ssh_url: 'git@github.com:graphile/postgraphile.git'
  pushed_at: '2019-02-13T11:47:49Z'
  updated_at: '2019-02-15T12:25:43Z'
  author:
    name: 'graphile'
    avatar: 'https://avatars1.githubusercontent.com/u/30540084?v=4'
    github_url: 'https://github.com/graphile'
  latestRelease:
    tag_name: 'v4.3.3'
    name: 'v4.3.3: patch issue with DEBUG + pgPool.query'
    url: 'https://github.com/graphile/postgraphile/releases/tag/v4.3.3'
    created_at: '2019-02-05T18:23:45Z'
---
