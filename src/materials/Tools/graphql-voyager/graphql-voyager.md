---
path: '/materials/graphql-voyager'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-voyager'
  url: 'https://apis.guru/graphql-voyager/'
  github_url: 'https://github.com/APIs-guru/graphql-voyager'
  subscribers_count: '85'
  stargazers_count: '3606'
  tags: ['api-documentation','graphql','graphql-tools','graphviz','visualization']
  subtitle: '🛰️ Represent any GraphQL API as an interactive graph'
  clone_url: 'https://github.com/APIs-guru/graphql-voyager.git'
  ssh_url: 'git@github.com:APIs-guru/graphql-voyager.git'
  pushed_at: '2019-01-04T21:07:26Z'
  updated_at: '2019-02-15T14:13:07Z'
  author:
    name: 'APIs-guru'
    avatar: 'https://avatars0.githubusercontent.com/u/10975548?v=4'
    github_url: 'https://github.com/APIs-guru'
  latestRelease:
    tag_name: 'v1.0.0-rc.7'
    name: 'v1.0.0-rc.7'
    url: 'https://github.com/APIs-guru/graphql-voyager/releases/tag/v1.0.0-rc.7'
    created_at: '2017-07-21T14:50:34Z'
---
# GraphQL Voyager
