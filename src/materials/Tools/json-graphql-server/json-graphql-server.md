---
path: '/materials/json-graphql-server'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'json-graphql-server'
  url: 'https://github.com/marmelab/json-graphql-server'
  github_url: 'https://github.com/marmelab/json-graphql-server'
  subscribers_count: '28'
  stargazers_count: '608'
  tags: ['express-graphql','graphql','graphql-server']
  subtitle: 'Get a full fake GraphQL API with zero coding in less than 30 seconds.'
  clone_url: 'https://github.com/marmelab/json-graphql-server.git'
  ssh_url: 'git@github.com:marmelab/json-graphql-server.git'
  pushed_at: '2018-11-27T16:58:37Z'
  updated_at: '2019-02-14T04:33:37Z'
  author:
    name: 'marmelab'
  ...
  latestRelease:
    tag_name: 'v2.1.3'
    name: 'v2.1.3'
    url: 'https://github.com/marmelab/json-graphql-server/releases/tag/v2.1.3'
    created_at: '2018-11-27T16:56:24Z'
---
# json-graphql-server
