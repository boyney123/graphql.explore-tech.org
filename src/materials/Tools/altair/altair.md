---
path: '/materials/altair'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'altair'
  url: 'https://altair.sirmuel.design/'
  github_url: 'https://github.com/imolorhe/altair'
  subscribers_count: '20'
  stargazers_count: '871'
  tags: ['altair','angular','chrome-extension','data','database','desktop-apps','electron','express-middleware','fossa-status','fragments','graphiql','graphql','graphql-client','graphql-editor','graphql-ide','graphql-server','graphql-subscriptions','ngrx','opensource']
  subtitle: '✨⚡️ A beautiful feature-rich GraphQL Client for all platforms.'
  clone_url: 'https://github.com/imolorhe/altair.git'
  ssh_url: 'git@github.com:imolorhe/altair.git'
  pushed_at: '2019-02-15T11:00:27Z'
  updated_at: '2019-02-15T12:25:45Z'
  author:
    name: 'imolorhe'
    avatar: 'https://avatars1.githubusercontent.com/u/4608143?v=4'
    github_url: 'https://github.com/imolorhe'
  latestRelease:
    tag_name: 'v2.0.7'
    name: ''
    url: 'https://github.com/imolorhe/altair/releases/tag/v2.0.7'
    created_at: '2019-02-02T03:50:54Z'
---
