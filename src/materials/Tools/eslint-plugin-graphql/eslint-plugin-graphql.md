---
path: '/materials/eslint-plugin-graphql'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'eslint-plugin-graphql'
  url: 'https://www.npmjs.com/package/eslint-plugin-graphql'
  github_url: 'https://github.com/apollographql/eslint-plugin-graphql'
  subscribers_count: '30'
  stargazers_count: '675'
  tags: ['']
  subtitle: ':vertical_traffic_light: Check your GraphQL query strings against a schema.'
  clone_url: 'https://github.com/apollographql/eslint-plugin-graphql.git'
  ssh_url: 'git@github.com:apollographql/eslint-plugin-graphql.git'
  pushed_at: '2019-02-02T23:44:59Z'
  updated_at: '2019-02-14T22:41:18Z'
  author:
    name: 'apollographql'
  ...
  latestRelease:
    tag_name: 'v0.7.0'
    name: 'Adding validation for optional GraphQL rules'
    url: 'https://github.com/apollographql/eslint-plugin-graphql/releases/tag/v0.7.0'
    created_at: '2017-03-15T17:39:59Z'
---
