---
path: '/materials/join-monster'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'join-monster'
  url: 'http://join-monster.readthedocs.io/en/latest/'
  github_url: 'https://github.com/acarl005/join-monster'
  subscribers_count: '54'
  stargazers_count: '1753'
  tags: ['graphql','graphql-js','join','nodejs','sql','sql-query']
  subtitle: 'A GraphQL to SQL query execution layer for query planning and batch data fetching.'
  clone_url: 'https://github.com/acarl005/join-monster.git'
  ssh_url: 'git@github.com:acarl005/join-monster.git'
  pushed_at: '2019-02-15T00:10:16Z'
  updated_at: '2019-02-13T16:58:54Z'
  author:
    name: 'acarl005'
    avatar: 'https://avatars0.githubusercontent.com/u/8334252?v=4'
    github_url: 'https://github.com/acarl005'
  latestRelease:
    tag_name: 'v2.0.0'
    name: 'Join Monster V2'
    url: 'https://github.com/acarl005/join-monster/releases/tag/v2.0.0'
    created_at: '2017-06-27T22:44:39Z'
---
