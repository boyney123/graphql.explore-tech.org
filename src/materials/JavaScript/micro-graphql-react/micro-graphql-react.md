---
path: '/materials/micro-graphql-react'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'micro-graphql-react'
  url: 'https://github.com/arackaf/micro-graphql-react'
  github_url: 'https://github.com/arackaf/micro-graphql-react'
  subscribers_count: '10'
  stargazers_count: '302'
  tags: ['']
  subtitle: 'Light and simple utility for adding GraphQL to React components.  Executes queries via HTTP GET, allowing you to cache results via Service Worker, rather than potentially large client-side solutions.'
  clone_url: 'https://github.com/arackaf/micro-graphql-react.git'
  ssh_url: 'git@github.com:arackaf/micro-graphql-react.git'
  pushed_at: '2019-02-11T04:23:25Z'
  updated_at: '2019-02-14T22:30:50Z'
  author:
    name: 'arackaf'
    avatar: 'https://avatars2.githubusercontent.com/u/11261266?v=4'
    github_url: 'https://github.com/arackaf'
  latestRelease:
    tag_name: 'v0.1.2'
    name: '0.1.2'
    url: 'https://github.com/arackaf/micro-graphql-react/releases/tag/v0.1.2'
    created_at: '2018-04-02T01:05:11Z'
---
