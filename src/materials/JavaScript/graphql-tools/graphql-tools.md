---
path: '/materials/graphql-tools'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-tools'
  url: 'https://www.apollographql.com/docs/graphql-tools/'
  github_url: 'https://github.com/apollographql/graphql-tools'
  subscribers_count: '90'
  stargazers_count: '2604'
  tags: ['apollographql','graphql','graphql-schema','schema-language']
  subtitle: ':wrench: Build, mock, and stitch a GraphQL schema using the schema language'
  clone_url: 'https://github.com/apollographql/graphql-tools.git'
  ssh_url: 'git@github.com:apollographql/graphql-tools.git'
  pushed_at: '2019-02-10T15:07:10Z'
  updated_at: '2019-02-15T03:20:33Z'
  author:
    name: 'apollographql'
  ...
  latestRelease:
    tag_name: 'v4.0.4'
    name: '4.0.4'
    url: 'https://github.com/apollographql/graphql-tools/releases/tag/v4.0.4'
    created_at: '2019-01-24T15:18:19Z'
---
