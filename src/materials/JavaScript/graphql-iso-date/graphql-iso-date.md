---
path: '/materials/graphql-iso-date'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-iso-date'
  url: 'https://github.com/excitement-engineer/graphql-iso-date'
  github_url: 'https://github.com/excitement-engineer/graphql-iso-date'
  subscribers_count: '6'
  stargazers_count: '266'
  tags: ['graphql','graphql-js','graphql-scalar']
  subtitle: 'A set of RFC 3339 compliant date/time GraphQL scalar types.'
  clone_url: 'https://github.com/excitement-engineer/graphql-iso-date.git'
  ssh_url: 'git@github.com:excitement-engineer/graphql-iso-date.git'
  pushed_at: '2019-01-28T19:09:28Z'
  updated_at: '2019-02-11T04:53:09Z'
  author:
    name: 'excitement-engineer'
    avatar: 'https://avatars2.githubusercontent.com/u/19558321?v=4'
    github_url: 'https://github.com/excitement-engineer'
  latestRelease:
    tag_name: 'v3.6.1'
    name: 'v3.6.1'
    url: 'https://github.com/excitement-engineer/graphql-iso-date/releases/tag/v3.6.1'
    created_at: '2018-09-16T10:18:01Z'
---
# GraphQL ISO Date
