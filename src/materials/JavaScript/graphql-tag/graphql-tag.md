---
path: '/materials/graphql-tag'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-tag'
  url: 'https://github.com/apollographql/graphql-tag'
  github_url: 'https://github.com/apollographql/graphql-tag'
  subscribers_count: '38'
  stargazers_count: '1009'
  tags: ['']
  subtitle: 'A JavaScript template literal tag that parses GraphQL queries'
  clone_url: 'https://github.com/apollographql/graphql-tag.git'
  ssh_url: 'git@github.com:apollographql/graphql-tag.git'
  pushed_at: '2019-02-06T14:47:11Z'
  updated_at: '2019-02-15T09:55:30Z'
  author:
    name: 'apollographql'
