---
path: '/materials/graphql-request'
type: 'GitHub'
img: './screenshot.png'
material:
  title: 'graphql-request'
  url: 'https://github.com/prisma/graphql-request'
  github_url: 'https://github.com/prisma/graphql-request'
  subscribers_count: '24'
  stargazers_count: '1427'
  tags: ['graphql','graphql-client','graphql-request','lightweight','nodejs','typescript']
  subtitle: '📡  Minimal GraphQL client supporting Node and browsers for scripts or simple apps'
  clone_url: 'https://github.com/prisma/graphql-request.git'
  ssh_url: 'git@github.com:prisma/graphql-request.git'
  pushed_at: '2019-02-13T18:54:19Z'
  updated_at: '2019-02-15T02:03:30Z'
  author:
    name: 'prisma'
  ...
  latestRelease:
    tag_name: 'v1.8.2'
    name: 'v1.8.2'
    url: 'https://github.com/prisma/graphql-request/releases/tag/v1.8.2'
    created_at: '2018-08-10T07:29:56Z'
---
# graphql-request
